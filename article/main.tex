...
\begin{lstlisting}[language=bash,basicstyle=\ttfamily\scriptsize,numbers=none]
...
\begin{lstlisting}[basicstyle=\ttfamily\scriptsize,numbers=none,label=lst:directory-structure]
tfp-example
|-- docs
|   |-- index.md
|-- example
