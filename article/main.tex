...
In Wiremock this can be depicted as a \emph{Scenario}~\cite{noauthor_wiremock_stateful_behavior_2025}. Our article is a children shampoo and the corresponding file is in listing~\ref{lst:article-scenario}.
\hspace{-3em}\begin{lstlisting}[
  basicstyle=\ttfamily\scriptsize,
  numbers=none,
  label={lst:article-scenario}
  ]
{
  "mappings": [
    {
      "scenarioName": "Shampoo",
    ...
    },
    {
      "scenarioName": "Shampoo",
      "requiredScenarioState": "Started",
      "newScenarioState": "Shampoo added",
	  "request": {
        "method": "POST",
        "url": "/articles"
      },
      "response": {
        "status": 201,
        "body": "{\"id\":1,\"name\":\"Princess Rosalea\",\"description\":\"Child Shampoo & Conditioner\"}",
        "headers": {
          "Content-Type": "application/json"
        }
      }
    ...
    {
      "scenarioName": "Shampoo",
      "requiredScenarioState": "Shampoo added",
      "request": {
        "method": "GET",
        "url": "/articles/1"
      },
    ...
    },
    {
      "scenarioName": "Shampoo",
      "requiredScenarioState": "Shampoo added",
      "newScenarioState": "Shampoo changed",
      "request": {
        "method": "PUT",
        "url": "/articles/1"
      },
      "response": {
        "status": 200,
        "body": "{\"id\":1,\"name\":\"Princess Rosalea\",\"description\":\"Child Shampoo & Conditioner. Soft on the skin, soft on the environment.\"}",
        "headers": {
          "Content-Type": "application/json"
        }
      }
    ...
    {
      "scenarioName": "Shampoo",
      "requiredScenarioState": "Shampoo changed",
      "request": {
        "method": "GET",
        "url": "/articles/1"
      },
